...
//        .body("results.gender", hasItems("male", "female"));робота зі строкою
    ...
    System.out.println(rootDto.getResults().get(0).getName().getLast());//робота з обєктом який
    //elier we зробили з json
